...
class MAStrategy(QA_Account):
    def __init__(self, user_cookie, portfolio_cookie, account_cookie,  init_cash=100000, init_hold={}):
        ...
        self.time_to_Market_300439 = '2017-04-22'
        self.time_to_day = '2017-07-01'
...
def run_daybacktest():
    ...
    time_to_Market_300439 = '2017-04-22'
    time_to_day = '2017-07-01'

    backtest = Backtest(market_type=MARKET_TYPE.STOCK_CN,
                        frequence=FREQUENCE.DAY,
                        start=time_to_Market_300439,
                        end=time_to_day,
                        code_list=['300439'],
